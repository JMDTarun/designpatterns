			...
			<div class="row h-100">
				<div class="col">
					<div class="card-wrapper">
						<div class="card fat">
							<div class="card-body">
								<h4 class="card-title">Area Manager</h4>
								...
								<form action="/addArea" method="POST">
									...
									<div class="form-group">
										<label for="name2">Name 2</label> <input id="name2"
											type="text" class="form-control" name="name2" required>
									</div>

									<div class="form-group">
										<label for="areaCode">Area Code</label> <input id="areaCode"
											type="text" class="form-control" name="areaCode" required>
									</div>

									<div class="form-group">
										<label for="lcoCode">LCO Code</label> <input id="lcoCode"
											type="text" class="form-control" name="lcoCode" required
											data-eye>
									</div>
									<div class="form-group">
										<label for="lcoName">LCO Name</label> <input id="lcoName"
											type="text" class="form-control" name="lcoName" required
											data-eye>
									</div>
