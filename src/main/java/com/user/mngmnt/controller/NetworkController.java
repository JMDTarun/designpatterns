...
public class NetworkController {
    ...
    public ViewPage<Network> getFilteredNetworks(String filters, PageRequest pageRequest) {
        String qId = null;
        String qName = null;
        ...
        if (qId != null)
            networks = networkRepository.findByIdLike("%" + qId + "%", pageRequest);
        if (qName != null)
            networks = networkRepository.findByNameLike("%" + qName + "%", pageRequest);
        return new ViewPage<>(networks);
    }
    ...
    public ViewPage<Channel> getFilteredChannels(String filters, PageRequest pageRequest) {
        String qId = null;
        String qName = null;
        ...
        Page<Channel> channels = null;
        if (qId != null)
            channels = channelRepository.findByIdLike("%" + qId + "%", pageRequest);
        if (qName != null)
            channels = channelRepository.findByNameLike("%" + qName + "%", pageRequest);
    ...
    public ViewPage<NetworkChannel> getFilteredNetworkChannel(String filters, PageRequest pageRequest) {
        String qId = null;
        String qName = null;
        ...
        Page<NetworkChannel> networkChannels = null;
        if (qId != null)
            networkChannels = networkChannelRepository.findByIdLike("%" + qId + "%", pageRequest);
        if (qName != null)
            networkChannels = networkChannelRepository.findByNameLike("%" + qName + "%", pageRequest);
        return new ViewPage<>(networkChannels);
    }
